            ...
            <div class="card">
                <div class="card-body">
                    <center class="mt-4">
                        ...
                        ?>
                        @if(empty($photo))
                        <img src="{{ asset('backend/profiles/default.jpg')}}" class="rounded-circle" width="150" />
                            @else
                                <img src="{{ asset('backend/profiles/'.$photo)}}" class="rounded-circle" width="150" />
                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-material" id="infoForm" method="post" action="{{ route('admin.updateInfo') }}">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="Full Name" name="fullname" value="{{ Auth::user()->name }}" class="form-control form-control-line" required>
                                    </div>
                                </div>
                                </div>
                                <div class="row">
                                <div class="form-group col-6">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <div class="col-md-12">
                                            <input type="tel" placeholder="078 456 7890" class="form-control form-control-line" value="{{ Auth::user()->telephone }}" required name="phone">
                                        </div>
                                    </div>
                                </div>
