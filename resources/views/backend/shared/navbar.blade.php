    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        <div class="navbar-header">
            ...
            <div class="d-none d-md-block text-center">
                <a class="sidebartoggler waves-effect waves-light d-flex align-items-center side-start" href="javascript:void(0)" data-sidebartype="mini-sidebar">
                    ...
                    <img src="{{asset('/assets/img/logo_votep.png')}}" class="light-logo" alt="pg" style="height: 65px !important;" />
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <!-- ============================================================== -->
                <li class="nav-item">
                    <a class="nav-link navbar-brand d-none d-md-block" href="/home">
                        <!-- Logo icon -->
                        <b class="logo-icon">
                            <!-- Light Logo icon -->
                            <img src="{{asset('/assets/img/logo_votep.png')}}" alt="homepage" class="light-logo" style="width: 45px;height: 45px" />
                        </b>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        ?>
                        @if(empty($photo))
                            <img src="{{ asset('backend/profiles/default.jpg')}}" alt="user" class="rounded-circle" width="31">
                        @else
                            <img src="{{ asset('/backend/profiles/'.$photo)}}" alt="user" class="rounded-circle" width="31">
                    ...
                    <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                        <div class="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                            <div class="">
                                ...
                                @if(empty($photo))
                                    <img src="{{ asset('backend/profiles/default.jpg')}}" alt="user" class="rounded" width="80">
                                @else
                                    <img src="{{ asset('backend/profiles/'.$photo)}}" alt="user" class="rounded" width="80">
                                @endif
                            </div>
                            <div class="ml-2">
